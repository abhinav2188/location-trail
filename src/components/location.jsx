...
const location = (props) => {
    return (
        <div className="border-l border-blue-400 h-16 rounded-sm flex flex-col  relative">
            ...
            <span className="ml-4 pl-4 ">Longitude : {props.longitude} Latitude : {props.latitude}</span>
        </div>
    );
}
